package com.triagung.mysharedpreferences
...
import com.triagung.mysharedpreferences.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_save) {
            ...
            saveUser(name, email, age.toInt(), phoneNo, isLoveMU)
    ...
    private fun saveUser(name: String, email: String, age: Int, phoneNo: String, isLoveMU: Boolean) {
